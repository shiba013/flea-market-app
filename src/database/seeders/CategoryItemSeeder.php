...
class CategoryItemSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('category_item')->insert([
            ...
            ['category_id' => 5, 'item_id' => 8],
            ['category_id' => 6, 'item_id' => 10],
            ['category_id' => 8, 'item_id' => 2],
            ['category_id' => 8, 'item_id' => 5],
            ['category_id' => 8, 'item_id' => 6],
            ['category_id' => 10, 'item_id' => 3],
            ['category_id' => 10, 'item_id' => 8],
            ['category_id' => 10, 'item_id' => 9],
            ['category_id' => 11, 'item_id' => 3],
            ['category_id' => 12, 'item_id' => 1],
            ['category_id' => 12, 'item_id' => 7],
        ]);
    }
}
